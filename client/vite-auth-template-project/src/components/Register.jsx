            ...
            <section className="w-full flex justify-center items-center h-screen  bg-gray-100 dark:bg-gray-800" >
                <div className="w-full max-w-lg xl:max-w-2xl p-6 space-y-4 bg-white rounded-lg shadow dark:border dark:border-gray-700 custom-width">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button disabled={!validEmail || !validFirstName || !validLastName || !validPhone || !validPwd || !validMatch} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
                            Sign Up
                        </button>
                    </form>
                    <p>
